...
export default function Home() {
  ...
  if (view === 'GRAPH') {
    return (
      <>
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: 2000, overflow: 'hidden' }} className="bg-gradient-to-br from-slate-950 via-black to-slate-900">
